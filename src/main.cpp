...
int64 nChainStartTime = 1529461357;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jun 11, 2018, start for SPCCoin.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x72c759c1a1974c937248b8ad4f6d2801f2caf172fe021b8a88e2026ec1beb62c"));
